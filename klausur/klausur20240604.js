...
console.log('Das Volumen eines Würfels mit der Kantenlänge ' + a + ' beträgt: ' + volumen + ' Kubikzentimeter.');
...
console.log('Die Kreiszahl Pi nimmt den Wert ' + pi + ' an.' );
...
let radius = 4;
let flächeninhalt = (pi * 4 * 4);

console.log('Der Kreis mit dem Radius ' + radius + ' hat einen Flächeninhalt von ' + flächeninhalt + ' Quadratzentimetern.');
...
console.log('Der Kreis mit dem Radius ' + radius + ' hat einen Umfang von ' + umfang + ' Zentimetern.');
...
console.log('Der Kreis mit dem Radius ' + radius + ' hat einen Durchmesser von ' + durchmesser + ' Zentimetern.')
...
console.log('Der Rabatt für eine Papierlieferung beträgt: ' + rabatt + ' Euro.');
...
console.log('Der Nettorechnungsbetrag einer Papierlieferung beträgt: ' + nettoRechnungsbetrag + ' Euro.');

// 3c)
// Berechnen Sie die MwSt in einer sprechenden Variablen. Geben Sie einen Anwortsatz auf der Konsole aus.

let MwSt = (nettoRechnungsbetrag * mehrwertsteuer / 100);

console.log('Der Mehrwertsteuerbetrag einer Papierlieferung beträgt: ' + MwSt + ' Euro.')
...
console.log('Die Zinszahlungen die in einem Zeitraum von 6 Monaten anfallen betragen: ' + Z + ' Euro.');
...
console.log(n + ' hat bei einer Körpergröße von ' + l + ' Metern und einem Körpergewicht von ' + m + ' Kilogramm einen BMI von ' + BMI);
